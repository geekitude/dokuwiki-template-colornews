                                ...
                                <div class="tg-footer-column-3">
                                    <aside id="colornews__about" class="widget widget_nav_menu">
                                        ...
                                        <div class="buttons">
                                            ...
                                            <a href="https://www.dokuwiki.org/template:colornews" title="ColorNews template"<?php _colornews_external_target(); ?>><img src="<?php print tpl_basedir(); ?>images/button-colornews.png" width="86" height="15" alt="Colornews template" /></a><?php (tpl_getConf('githubIssues') == 1) ? print '<sup class="issues"><a href="https://github.com/geekitude/dokuwiki-template-colornews/issues" title="Github issues"'._colornews_external_target(true).'>'.$colornews['issues'].'</a></sup>' : '' ?>
                                        </div><!-- .buttons -->
                                    </aside><!-- /#nav_menu-2 -->
                                </div><!-- /.tg-footer-column-3 -->
